...
from lms.apps.order import exceptions as order_exceptions
from lms.apps.payment.exceptions import PaymentError
from lms.core.compat import UnicodeCSVWriter
from lms.core.loading import get_class, get_model
from lms.core.utils import datetime_combine, format_datetime
from lms.views import sort_queryset
from lms.views.generic import BulkEditMixin
...
class OrderStatsView(FormView):
    ...
    template_name = "lms/dashboard/orders/statistics.html"
...
class OrderListView(EventHandlerMixin, BulkEditMixin, ListView):
    ...
    template_name = "lms/dashboard/orders/order_list.html"
...
class OrderDetailView(EventHandlerMixin, DetailView):
    ...
    template_name = "lms/dashboard/orders/order_detail.html"
...
class LineDetailView(DetailView):
    ...
    template_name = "lms/dashboard/orders/line_detail.html"
...
class ShippingAddressUpdateView(UpdateView):
    ...
    template_name = "lms/dashboard/orders/shippingaddress_form.html"
