...
from lms.core.validators import URLDoesNotExistValidator
...
class PageListView(ListView):
    ...
    template_name = "lms/dashboard/pages/index.html"
    model = FlatPage
...
class PageCreateUpdateMixin(object):
    template_name = "lms/dashboard/pages/update.html"
    model = FlatPage
    ...
    def get_success_url(self):
        msg = render_to_string(
            "lms/dashboard/pages/messages/saved.html", {"page": self.object}
        )
...
class PageDeleteView(generic.DeleteView):
    template_name = "lms/dashboard/pages/delete.html"
    model = FlatPage
