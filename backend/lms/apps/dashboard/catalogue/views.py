...
from lms.core.loading import get_class, get_classes, get_model
from lms.views.generic import ObjectLookupView
...
class ProductListView(PartnerProductFilterMixin, SingleTableView):
    ...
    template_name = "lms/dashboard/catalogue/product_list.html"
...
class ProductCreateUpdateView(PartnerProductFilterMixin, generic.UpdateView):
    ...
    template_name = "lms/dashboard/catalogue/product_update.html"
    model = Product
    ...
    def get_success_url(self):
        ...
        msg = render_to_string(
            "lms/dashboard/catalogue/messages/product_saved.html",
            {
                "product": self.object,
...
class ProductDeleteView(PartnerProductFilterMixin, generic.DeleteView):
    ...
    template_name = "lms/dashboard/catalogue/product_delete.html"
    model = Product
    context_object_name = "product"
...
class StockAlertListView(generic.ListView):
    template_name = "lms/dashboard/catalogue/stockalert_list.html"
    model = StockAlert
...
class CategoryListView(SingleTableView):
    template_name = "lms/dashboard/catalogue/category_list.html"
...
class CategoryCreateView(CategoryListMixin, generic.CreateView):
    template_name = "lms/dashboard/catalogue/category_form.html"
    model = Category
...
class CategoryDeleteView(CategoryListMixin, generic.DeleteView):
    template_name = "lms/dashboard/catalogue/category_delete.html"
    model = Category
...
class ProductClassCreateUpdateView(generic.UpdateView):
    template_name = "lms/dashboard/catalogue/product_class_form.html"
    model = ProductClass
...
class ProductClassListView(generic.ListView):
    template_name = "lms/dashboard/catalogue/product_class_list.html"
...
class ProductClassDeleteView(generic.DeleteView):
    template_name = "lms/dashboard/catalogue/product_class_delete.html"
    model = ProductClass
    form_class = ProductClassForm
...
class AttributeOptionGroupCreateUpdateView(generic.UpdateView):
    template_name = "lms/dashboard/catalogue/attribute_option_group_form.html"
...
class AttributeOptionGroupListView(SingleTableView):
    template_name = "lms/dashboard/catalogue/attribute_option_group_list.html"
    model = AttributeOptionGroup
...
class AttributeOptionGroupDeleteView(PopUpWindowDeleteMixin, generic.DeleteView):
    template_name = "lms/dashboard/catalogue/attribute_option_group_delete.html"
    model = AttributeOptionGroup
    form_class = AttributeOptionGroupForm
...
class OptionListView(SingleTableView):
    template_name = "lms/dashboard/catalogue/option_list.html"
    model = Option
...
class OptionCreateUpdateView(generic.UpdateView):
    template_name = "lms/dashboard/catalogue/option_form.html"
    model = Option
...
class OptionDeleteView(PopUpWindowDeleteMixin, generic.DeleteView):
    template_name = "lms/dashboard/catalogue/option_delete.html"
    model = Option
