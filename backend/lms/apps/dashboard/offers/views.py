...
class OfferListView(ListView):
    ...
    template_name = "lms/dashboard/offers/offer_list.html"
...
class OfferMetaDataView(OfferWizardStepView):
    ...
    template_name = "lms/dashboard/offers/metadata_form.html"
...
class OfferBenefitView(OfferWizardStepView):
    ...
    template_name = "lms/dashboard/offers/benefit_form.html"
...
class OfferConditionView(OfferWizardStepView):
    ...
    template_name = "lms/dashboard/offers/condition_form.html"
...
class OfferRestrictionsView(OfferWizardStepView):
    ...
    template_name = "lms/dashboard/offers/restrictions_form.html"
...
class OfferDeleteView(DeleteView):
    model = ConditionalOffer
    template_name = "lms/dashboard/offers/offer_delete.html"
...
class OfferDetailView(ListView):
    ...
    model = OrderDiscount
    template_name = "lms/dashboard/offers/offer_detail.html"
