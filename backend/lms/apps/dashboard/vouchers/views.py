...
class VoucherListView(generic.ListView):
    ...
    template_name = "lms/dashboard/vouchers/voucher_list.html"
...
class VoucherCreateView(generic.CreateView):
    model = Voucher
    template_name = "lms/dashboard/vouchers/voucher_form.html"
...
class VoucherStatsView(generic.DetailView):
    model = Voucher
    template_name = "lms/dashboard/vouchers/voucher_detail.html"
...
class VoucherDeleteView(generic.DeleteView):
    model = Voucher
    template_name = "lms/dashboard/vouchers/voucher_delete.html"
    context_object_name = "voucher"
...
class VoucherSetCreateView(generic.CreateView):
    model = VoucherSet
    template_name = "lms/dashboard/vouchers/voucher_set_form.html"
...
class VoucherSetDetailView(generic.ListView):
    model = Voucher
    context_object_name = "vouchers"
    template_name = "lms/dashboard/vouchers/voucher_set_detail.html"
...
class VoucherSetListView(generic.ListView):
    ...
    template_name = "lms/dashboard/vouchers/voucher_set_list.html"
    paginate_by = settings.OSCAR_DASHBOARD_ITEMS_PER_PAGE
...
class VoucherSetDeleteView(generic.DeleteView):
    model = VoucherSet
    template_name = "lms/dashboard/vouchers/voucher_set_delete.html"
    context_object_name = "voucher_set"
