...
class RangeListView(ListView):
    ...
    template_name = "lms/dashboard/ranges/range_list.html"
...
class RangeCreateView(CreateView):
    model = Range
    template_name = "lms/dashboard/ranges/range_form.html"
    ...
    def get_success_url(self):
        if "action" in self.request.POST:
            ...
            msg = render_to_string(
                "lms/dashboard/ranges/messages/range_saved.html",
                {"range": self.object},
            )
...
class RangeDeleteView(DeleteView):
    model = Range
    template_name = "lms/dashboard/ranges/range_delete.html"
...
class RangeProductListView(BulkEditMixin, ListView):
    model = Product
    template_name = "lms/dashboard/ranges/range_product_list.html"
    ...
    def handle_file_products(self, request, product_range, form):
        ...
        if not upload.was_processing_successful():
            ...
            msg = render_to_string(
                "lms/dashboard/ranges/messages/range_products_saved.html",
