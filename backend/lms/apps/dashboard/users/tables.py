...
class UserTable(DashboardTable):
    check = TemplateColumn(
        template_name="lms/dashboard/users/user_row_checkbox.html",
        verbose_name=" ",
        orderable=False,
    )
    ...
    actions = TemplateColumn(
        template_name="lms/dashboard/users/user_row_actions.html", verbose_name=" "
    )

    icon = "fas fa-users"

    class Meta(DashboardTable.Meta):
        template_name = "lms/dashboard/users/table.html"
