...
class IndexView(BulkEditMixin, FormMixin, SingleTableView):
    template_name = "lms/dashboard/users/index.html"
    model = User
    actions = (
        "make_active",
        "make_inactive",
...
class UserDetailView(DetailView):
    template_name = "lms/dashboard/users/detail.html"
    model = User
...
class ProductAlertListView(ListView):
    ...
    template_name = "lms/dashboard/users/alerts/list.html"
...
class ProductAlertUpdateView(UpdateView):
    template_name = "lms/dashboard/users/alerts/update.html"
    model = ProductAlert
...
class ProductAlertDeleteView(DeleteView):
    model = ProductAlert
    template_name = "lms/dashboard/users/alerts/delete.html"
    context_object_name = "alert"
