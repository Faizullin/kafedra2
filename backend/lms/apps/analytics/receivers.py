...
from lms.apps.basket.signals import basket_addition
from lms.apps.catalogue.signals import product_viewed
from lms.apps.order.signals import order_placed
from lms.apps.search.signals import user_search
...
logger = logging.getLogger("lms.analytics")
