...
class BasketMessageGenerator(object):
    new_total_template_name = "lms/basket/messages/new_total.html"
    offer_lost_template_name = "lms/basket/messages/offer_lost.html"
    offer_gained_template_name = "lms/basket/messages/offer_gained.html"
...
class LineOfferConsumer(object):
    ...
    historically lms marks a line as consumed if any
