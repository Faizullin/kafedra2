...
from lms.core.loading import get_class, get_classes
from lms.core.utils import get_default_currency, round_half_up
from lms.core.decorators import deprecated
from lms.models.fields.slugfield import SlugField
from lms.templatetags.currency_filters import currency
...
class AbstractLine(models.Model):
    ...
    Common approaches on ordering basket lines:
        ...
        a) First added at top. That's the history-like approach; new items are
           ...
           position.
           Lms does this by default. It just sorts by Line.pk, which is
