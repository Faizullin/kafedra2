...
from lms.apps.catalogue.reviews.signals import review_added
from lms.core.loading import get_classes, get_model
from lms.core.utils import redirect_to_referrer
...
class CreateProductReview(CreateView):
    template_name = "lms/catalogue/reviews/review_form.html"
    model = ProductReview
...
class ProductReviewDetail(DetailView):
    template_name = "lms/catalogue/reviews/review_detail.html"
...
class ProductReviewList(ListView):
    ...
    template_name = "lms/catalogue/reviews/review_list.html"
