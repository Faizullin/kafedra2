...
from lms.core.decorators import deprecated
from lms.core.loading import get_class, get_classes, get_model
from lms.core.utils import slugify
from lms.core.validators import non_python_keyword
from lms.models.fields import AutoSlugField, NullCharField
from lms.models.fields.slugfield import SlugField
from lms.utils.models import get_image_upload_path
...
class AbstractCategory(MP_Node):
    ...
    def full_name(self):
        ...
        It's rarely used in Lms, but used to be stored as a CharField and is
    ...
    def full_slug(self):
        ...
        Lms used to store this as in the 'slug' model field, but this field
    ...
    def save(self, *args, **kwargs):
        """
        Lms traditionally auto-generated slugs from names. As that is
...
class MissingProductImage(object):
    ...
    into MEDIA_ROOT for convenience, as that is necessary every time an Lms
    ...
    def symlink_missing_image(self, media_file_path):
        ...
        static_file_path = find("lms/img/%s" % self.name)
            ...
            try:
                ...
                raise ImproperlyConfigured(
                    (
                        ...
                        "This exception was raised because Lms was unable to "
                        "symlink it for you."
                    )
