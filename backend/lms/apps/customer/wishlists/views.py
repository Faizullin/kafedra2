...
from lms.core.utils import redirect_to_referrer, safe_referrer
...
class WishListListView(PageTitleMixin, ListView):
    ...
    template_name = "lms/customer/wishlists/wishlists_list.html"
...
class WishListDetailView(PageTitleMixin, FormView):
    ...
    template_name = "lms/customer/wishlists/wishlists_detail.html"
...
class WishListCreateView(WishListCreateUpdateViewMixin, CreateView):
    ...
    model = WishList
    template_name = "lms/customer/wishlists/wishlists_form.html"
    active_tab = "wishlists"
...
class WishListDeleteView(PageTitleMixin, DeleteView):
    model = WishList
    template_name = "lms/customer/wishlists/wishlists_delete.html"
    active_tab = "wishlists"
...
class WishListRemoveProduct(LineMixin, PageTitleMixin, DeleteView):
    template_name = "lms/customer/wishlists/wishlists_delete_product.html"
    active_tab = "wishlists"
