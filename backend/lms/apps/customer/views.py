...
from lms.apps.customer.utils import get_password_reset_url
...
class AccountRegistrationView(RegisterUserMixin, generic.FormView):
    ...
    template_name = "lms/customer/registration.html"
...
class AccountAuthView(RegisterUserMixin, generic.TemplateView):
    ...
    template_name = "lms/customer/login_registration.html"
...
class ProfileView(PageTitleMixin, generic.TemplateView):
    template_name = "lms/customer/profile/profile.html"
...
class ProfileUpdateView(PageTitleMixin, generic.FormView):
    ...
    template_name = "lms/customer/profile/profile_form.html"
...
class ChangePasswordView(PageTitleMixin, generic.FormView):
    ...
    template_name = "lms/customer/profile/change_password_form.html"
