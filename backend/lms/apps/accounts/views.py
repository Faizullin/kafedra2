...
from lms.apps.accounts import signals
from lms.apps.accounts.utils import get_password_reset_url
from lms.core.compat import get_user_model
from lms.core.loading import get_class, get_classes, get_model, get_profile_class
from lms.core.utils import safe_referrer
from lms.views.generic import PostActionMixin

# from . import signals

PageTitleMixin, RegisterUserMixin = get_classes(
    "accounts.mixins", ["PageTitleMixin", "RegisterUserMixin"]
)
CustomerDispatcher = get_class("accounts.utils", "CustomerDispatcher")
...
class AccountSummaryView(generic.RedirectView):
    ...
    Lms defaults to just redirecting to the profile summary page (and
    ...
    pattern_name = settings.LMS_ACCOUNTS_REDIRECT_URL
    permanent = False


class AccountRegistrationView(RegisterUserMixin, generic.FormView):
    form_class = EmailUserCreationForm
    template_name = "lms/accounts/registration.html"
...
class AccountAuthView(RegisterUserMixin, generic.TemplateView):
    ...
    template_name = "lms/accounts/login_registration.html"
...
class LogoutView(generic.RedirectView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        # for cookie in settings.LMS_COOKIES_DELETE_ON_LOGOUT: TODO: remove or uncomment
...
class ProfileView(PageTitleMixin, generic.TemplateView):
    template_name = "lms/accounts/profile/profile.html"
...
class ProfileUpdateView(PageTitleMixin, generic.FormView):
    ...
    template_name = "lms/accounts/profile/profile_form.html"
...
#     template_name = "lms/customer/profile/profile_delete.html"
...
class ChangePasswordView(PageTitleMixin, generic.FormView):
    ...
    template_name = "lms/accounts/profile/change_password_form.html"
...
#     template_name = "lms/communication/email/email_list.html"
...
#         """
#         Return Queryset of :py:class:`Email <lms.apps.customer.abstract_models.AbstractEmail>`
...
#     template_name = "lms/communication/email/email_detail.html"
...
#     template_name = "lms/customer/order/order_list.html"
...
#     def get_queryset(self):
#         """
#         Return Queryset of :py:class:`Order <lms.apps.order.abstract_models.AbstractOrder>`
...
#         return ["lms/customer/order/order_detail.html"]
...
#     model = Order
#     template_name = "lms/customer/anon_order.html"
...
#     template_name = "lms/customer/address/address_list.html"
...
#     model = UserAddress
#     template_name = "lms/customer/address/address_form.html"
#     active_tab = "addresses"
...
#     model = UserAddress
#     template_name = "lms/customer/address/address_delete.html"
