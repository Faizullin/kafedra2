...
class AccountsConfig(LmsConfig):
    label = "accounts"
    ...
    def ready(self):
        ...
        self.summary_view = get_class("accounts.views", "AccountSummaryView")
        ...
        self.login_view = get_class("accounts.views", "AccountAuthView")
        self.logout_view = get_class("accounts.views", "LogoutView")
        self.register_view = get_class("accounts.views", "AccountRegistrationView")
        self.profile_view = get_class("accounts.views", "ProfileView")
        self.profile_update_view = get_class("accounts.views", "ProfileUpdateView")
        # self.profile_delete_view = get_class("accounts.views", "ProfileDeleteView")
        self.change_password_view = get_class("accounts.views", "ChangePasswordView")
    ...
    def get_urls(self):
        urls = [
            ...
            path("accounts/login/", self.login_view.as_view(), name="login"),
            path("accounts/logout/", self.logout_view.as_view(), name="logout"),
            path("accounts/register/", self.register_view.as_view(), name="register"),
            path("accounts", login_required(self.summary_view.as_view()), name="summary"),
            path(
