...
from lms.apps.order.signals import order_line_status_changed, order_status_changed
from lms.apps.partner.exceptions import InvalidStockAdjustment
from lms.core.compat import AUTH_USER_MODEL
from lms.core.loading import get_model
from lms.core.utils import get_default_currency
from lms.models.fields import AutoSlugField

from . import exceptions

logger = logging.getLogger("lms.order")
...
class AbstractOrder(models.Model):
    ...
    def verification_hash(self):
        signer = Signer(salt="lms.apps.order.Order")
