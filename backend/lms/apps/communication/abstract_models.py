...
from lms.apps.communication.managers import CommunicationTypeManager
from lms.core.compat import AUTH_USER_MODEL
from lms.models.fields import AutoSlugField
...
class AbstractCommunicationEventType(models.Model):
    ...
    # it's a useful convention that's been enforced in previous Lms versions
    code = AutoSlugField(
        _("Code"),
        max_length=128,
        unique=True,
    ...
    # instructs Lms to look for a file-based template, '' is just an empty
    # template.
    ...
    # File templates
    email_subject_template_file = "lms/communication/emails/commtype_%s_subject.txt"
    email_body_template_file = "lms/communication/emails/commtype_%s_body.txt"
    email_body_html_template_file = "lms/communication/emails/commtype_%s_body.html"
    sms_template_file = "lms/communication/sms/commtype_%s_body.txt"
