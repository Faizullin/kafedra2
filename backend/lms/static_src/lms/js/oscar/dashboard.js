...
var lms = (function (o, $) {
  function onFileChange(evt) {
    ...
    if (numExisting < numMax) {
      ...
      $newImg
        .find("#id_images-" + numExisting + "-display_order")
        .val(numExisting);
  ...
  o.dashboard = {
    init: function (options) {
      ...
      $('[data-behaviour="tab-nav-errors"] .tab-pane').each(function () {
        var productErrorListener = $(this)
          ...
          .closest(".tab-pane")
          .attr("id");
        $('.tab-nav a[href="#' + productErrorListener + '"]').append(
    ...
    initSelects: function (el) {
      ...
      $selects
        .not(".related-widget-wrapper select")
    ...
    initDatePickers: function (el) {
      if ($.fn.datetimepicker) {
        ...
        $.fn.datetimepicker.Constructor.Default = $.extend(
          ...
          o.dashboard.options.datetimePickerConfig,
        );
    ...
    initWYSIWYG: function (el) {
      ...
      var $textareas = $(el)
        ...
        .not(".no-widget-init");
      $textareas
        .filter("form.wysiwyg textarea")
        .tinymce(o.dashboard.options.tinyConfig);
    ...
    offers: {
      init: function () {
        lms.dashboard.offers.adjustBenefitForm();
