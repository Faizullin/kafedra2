...
function layout_header_change(value) {
  if (value == "dark") {
    document
      .getElementsByTagName("body")[0]
      .setAttribute("data-pc-header-theme", "dark");
    var control = document.querySelector(".theme-header-color .btn.active");
    if (control) {
      document
        .querySelector(".theme-header-color .btn.active")
        .classList.remove("active");
      document
        .querySelector(".theme-header-color .btn[data-value='true']")
        .classList.add("active");
    }
  } else {
    document
      .getElementsByTagName("body")[0]
      .setAttribute("data-pc-header-theme", "light");
    var control = document.querySelector(".theme-header-color .btn.active");
    if (control) {
      document
        .querySelector(".theme-header-color .btn.active")
        .classList.remove("active");
      document
        .querySelector(".theme-header-color .btn[data-value='false']")
        .classList.add("active");
    }
  }
}
