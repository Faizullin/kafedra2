      ...
      if (targetElement.parentNode.classList.contains("pc-hasmenu")) {
        if (targetElement.parentNode.classList.contains("pc-trigger")) {
          ...
          document.querySelector(
            ".pc-compact-submenu > .pc-compact-list .simplebar-content",
          ).innerHTML = "";
          document
          ...
          document.querySelector(
            ".pc-compact-submenu > .pc-compact-title h5",
          ).innerHTML = targetElement.children[1].innerHTML;
          document.querySelector(
            ".pc-compact-submenu > .pc-compact-title .avtar",
          ).innerHTML = targetElement.children[0].children[0].outerHTML;
          document
            .querySelector(".pc-compact-submenu > .pc-compact-title .avtar i")
          ...
          if (
            !!document.querySelector(".pc-compact-submenu > .pc-compact-list")
          ) {
            new SimpleBar(
              document.querySelector(".pc-compact-submenu > .pc-compact-list"),
            );
          ...
          var pc_link_click = document.querySelectorAll(
            ".pc-compact-list .simplebar-content>ul > li:not(.pc-caption)",
          );
          for (var i = 0; i < pc_link_click.length; i++) {
            pc_link_click[i].addEventListener("click", function (event) {
              event.stopPropagation();
              ...
              if (targetElement.parentNode.classList.contains("pc-trigger")) {
                ...
                var tc = document.querySelectorAll(
                  ".pc-compact-list .simplebar-content>ul li.pc-trigger",
                );
                for (var t = 0; t < tc.length; t++) {
                  var c = tc[t];
                  c.classList.remove("pc-trigger");
          ...
          var pc_sub_link_click = document.querySelectorAll(
            ".pc-compact-list .simplebar-content>ul > li:not(.pc-caption) li",
          );
