...
function floatchart() {
  (function () {
    ...
    var chart = new ApexCharts(
      document.querySelector("#total-line-1-chart"),
      total_line_1_chart_options,
    );
    chart.render();
    ...
    var chart = new ApexCharts(
      document.querySelector("#total-line-2-chart"),
      total_line_2_chart_options,
    );
    chart.render();
    ...
    var chart = new ApexCharts(
      document.querySelector("#total-line-3-chart"),
      total_line_3_chart_options,
    );
    chart.render();
    ...
    var chart = new ApexCharts(
      document.querySelector("#cashflow-bar-chart"),
      cashflow_bar_chart_options,
    );
    chart.render();
