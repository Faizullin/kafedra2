...
setTimeout(function () {
  (function () {
    ...
    var options5 = {
      ...
      colors: ["#7267EF", "#1DE9B6", "#F4C22B", "#3EBFEA"],
      responsive: [
        {
          breakpoint: 480,
          options: {
    ...
    var options7 = {
      ...
      colors: ["#7267EF", "#3EBFEA", "#1DE9B6", "#F4C22B", "#F44236"],
      stroke: {
        width: 1,
        colors: ["#fff"],
      },
    ...
    var options11 = {
      ...
      colors: ["#7267EF", "#1DE9B6", "#F4C22B", "#F44236"],
      fill: {
        opacity: 0.8,
      },
      xaxis: {
    ...
    var options13 = {
      ...
      colors: ["#7267EF", "#1DE9B6", "#F44236", "#F4C22B", "#3EBFEA"],
      series: [
        {
          name: "SAMPLE A",
          data: [
    ...
    var options17 = {
      ...
      colors: ["#7267EF", "#1DE9B6", "#3EBFEA", "#F4C22B", "#F44236"],
      legend: {
        show: true,
        position: "bottom",
      },
