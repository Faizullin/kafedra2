...
LMS_NAME = "Lms"
LMS_TAGLINE = ""
LMS_HOMEPAGE = reverse_lazy("pages:home")
LMS_HOMEPAGE_URL = ""

# Dynamic class loading
LMS_DYNAMIC_CLASS_LOADER = "lms.core.loading.default_class_loader"
...
# # Currency
# LMS_DEFAULT_CURRENCY = "GBP" TODO: move currency logic to spe app

# Paths
LMS_IMAGE_FOLDER = "images/products/%Y/%m/"
LMS_DELETE_IMAGE_FILES = True

# Copy this image from lms/static/img to your MEDIA_ROOT folder.
# It needs to be there so Sorl can resize it.
LMS_MISSING_IMAGE_URL = "image_not_found.jpg"

# # Address settings
# LMS_REQUIRED_ADDRESS_FIELDS = (
#     "first_name",
#     "last_name",
#     "line1",
#     "line4",
...
# OSCAR_DASHBOARD_ITEMS_PER_PAGE = 20 TODO: move to simple view filter class

# Checkout
LMS_ALLOW_ANON_CHECKOUT = False

# Reviews
LMS_ALLOW_ANON_REVIEWS = True
LMS_MODERATE_REVIEWS = True

# Accounts
LMS_ACCOUNTS_REDIRECT_URL = "accounts:profile-view"
...
# Alternatively, the management command ``lms_send_alerts`` can be used to
# run periodically, e.g. as a cron job. In this case eager alerts should be
# disabled.
LMS_EAGER_ALERTS = True

# Registration
LMS_SEND_REGISTRATION_EMAIL = True
LMS_FROM_EMAIL = "lms@example.com"

# Slug handling
LMS_SLUG_FUNCTION = "lms.core.utils.default_slugifier"
LMS_SLUG_MAP = {}
LMS_SLUG_BLACKLIST = []
LMS_SLUG_ALLOW_UNICODE = False

# # Cookies
# LMS_COOKIES_DELETE_ON_LOGOUT = [
...
# Hidden Lms features, e.g. wishlists or reviews
LMS_HIDDEN_FEATURES = []

# Menu structure of the dashboard navigation
LMS_DASHBOARD_NAVIGATION = [
    {
        "label": _("Dashboard"),
        "icon": "fas fa-list",
...
LMS_DASHBOARD_DEFAULT_ACCESS_FUNCTION = "lms.apps.dashboard.nav.default_access_fn"
...
LMS_THUMBNAILER = "lms.core.thumbnails.SorlThumbnail"

LMS_URL_SCHEMA = "http"

LMS_SAVE_SENT_EMAILS_TO_DB = True
