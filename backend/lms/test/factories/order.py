...
from lms.test import factories
from lms.test.factories.utils import tax_add, tax_subtract
...
class BillingAddressFactory(factory.django.DjangoModelFactory):
    country = factory.SubFactory("lms.test.factories.CountryFactory")
...
class OrderFactory(factory.django.DjangoModelFactory):
    ...
    basket = factory.SubFactory("lms.test.factories.BasketFactory")
...
class OrderLineFactory(factory.django.DjangoModelFactory):
    ...
    product = factory.SubFactory("lms.test.factories.ProductFactory")
