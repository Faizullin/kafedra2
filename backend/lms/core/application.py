...
class LmsConfigMixin(object):
    """
    Base Lms app configuration mixin, used to extend :py:class:`django.apps.AppConfig`
...
class LmsConfig(LmsConfigMixin, AppConfig):
    """
    Base Lms app configuration.
