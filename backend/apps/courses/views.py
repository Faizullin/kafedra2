...
def course_single(request, slug):
    ...
    # lecturers = User.objects.filter(allocated_lecturer__pk=courses.id)
...
def course_edit(request, slug):
    ...
    return render(
        ...
        {
            "title": "Edit Course",
            # 'form': form, 'program': pk, 'courses': pk
            "form": form,
        },
    )
...
class CourseAllocationFormView(CreateView):
    ...
    def form_valid(self, form):
        # if a staff has been allocated a courses before update it else create new
...
def edit_allocated_course(request, pk):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            form.save()
            messages.success(request, "courses assigned has been updated.")
            return redirect("course_allocation_view")
    else:
...
def handle_file_upload(request, slug):
    ...
    return render(
        ...
        {"title": "File Upload", "form": form, "courses": course},
    )
...
def handle_file_edit(request, slug, file_id):
    ...
    return render(
        request,
        "upload/upload_file_form.html",
        {"title": instance.title, "form": form, "courses": course},
    )
...
def handle_video_upload(request, slug):
    ...
    return render(
        ...
        {"title": "Video Upload", "form": form, "courses": course},
    )
...
def course_registration(request):
    if request.method == "POST":
        ...
        no_course_is_registered = False  # Check if no courses is registered
