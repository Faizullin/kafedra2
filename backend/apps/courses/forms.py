...
class CourseAllocationForm(forms.ModelForm):
    ...
    lecturer = forms.ModelChoiceField(
        queryset=UserModel.objects.filter(is_lecturer=True),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["lecturer"].queryset = UserModel.objects.filter(is_lecturer=True)
...
# Upload files to specific courses
...
# Upload video to specific courses
