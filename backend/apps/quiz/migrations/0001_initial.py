    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exam_paper', models.BooleanField(default=False, help_text='If yes, the results of each attempt by a user will be stored. Necessary for marking.', verbose_name='Exam Paper')),
