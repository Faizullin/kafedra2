...
class QuizCreateView(CreateView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        context["courses"] = Course.objects.get(slug=self.kwargs["slug"])
...
def quiz_list(request, slug):
    ...
    course = Course.objects.get(slug=slug)
    return render(
        request, "quiz/quiz_list.html", {"quizzes": quizzes, "courses": course}
    )
...
class QuizTake(FormView):
    ...
    result_template_name = "results.html"
    ...
    def get_context_data(self, **kwargs):
        ...
        context["courses"] = get_object_or_404(Course, pk=self.kwargs["pk"])
    ...
    def final_result_user(self):
        results = {
            "courses": get_object_or_404(Course, pk=self.kwargs["pk"]),
            "quiz": self.quiz,
