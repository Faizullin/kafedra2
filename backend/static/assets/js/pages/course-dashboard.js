...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const datepicker_inline = new Datepicker(
    document.querySelector("#pc-datepicker-6"),
    {
      buttonClass: "btn",
    },
  );
...
function floatchart() {
  (function () {
    ...
    var chart = new ApexCharts(
      document.querySelector("#revenue-sales-chart"),
      options,
    );
    chart.render();
    ...
    var chart = new ApexCharts(
      document.querySelector("#invites-goal-chart"),
      invites_goal_chart_option,
    );
    chart.render();
    ...
    var chart = new ApexCharts(
      document.querySelector("#total-revenue-line-1-chart"),
    ...
    var chart = new ApexCharts(
      document.querySelector("#total-revenue-line-2-chart"),
    ...
    var chart = new ApexCharts(
      document.querySelector("#student-states-chart"),
    ...
    var chart = new ApexCharts(
      document.querySelector("#activity-line-chart"),
      activity_line_chart_options,
    );
    chart.render();
    ...
    var chart = new ApexCharts(
      document.querySelector("#visitors-bar-chart"),
      visitors_bar_chart_options,
    );
    chart.render();
    ...
    var chart = new ApexCharts(
      document.querySelector("#earning-courses-line-chart"),
      earning_courses_line_chart_options,
    );
    chart.render();
  })();
}
