...
(function () {
  document.addEventListener("DOMContentLoaded", function () {
    ...
    document
      .querySelector("#btn-nt-show")
      .addEventListener("click", showNotification);

    document
      .querySelector("#btn-nt-hide")
