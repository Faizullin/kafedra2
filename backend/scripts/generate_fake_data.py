...
from apps.accounts.models import User, DepartmentHead
...
class CourseFactory(DjangoModelFactory):
    ...
    Attributes:
        slug (str): The generated slug for the courses.
        title (str): The generated title for the courses.
        code (str): The generated code for the courses.
        credit (int): The generated credit for the courses.
        summary (str): The generated summary for the courses.
        program (Program): The associated program for the courses.
        level (str): The generated level for the courses.
        year (int): The generated year for the courses.
        semester (str): The generated semester for the courses.
        is_elective (bool): The flag indicating if the courses is elective.
    """
...
class CourseAllocationFactory(DjangoModelFactory):
    ...
    Attributes:
        lecturer (User): The associated lecturer for the courses allocation.
        session (Session): The associated session for the courses allocation.
    """
...
class UploadFactory(DjangoModelFactory):
    ...
    Attributes:
        ...
        course (Course): The associated courses for the upload.
...
class UploadVideoFactory(DjangoModelFactory):
    ...
    Attributes:
        ...
        course (Course): The associated courses for the video upload.
...
class CourseOfferFactory(DjangoModelFactory):
    ...
    Attributes:
        dep_head (DepartmentHead): The associated department head for the courses offer.
    """
...
def generate_fake_course_data(num_programs: int, num_courses: int, num_course_allocations: int, num_uploads: int, num_upload_videos: int, num_course_offers: int) -> None:
    ...
    Args:
        ...
        num_course_allocations (int): Number of fake courses allocations to create.
        num_uploads (int): Number of fake uploads to create.
        num_upload_videos (int): Number of fake upload videos to create.
        num_course_offers (int): Number of fake courses offers to create.
    """
    ...
    # Generate fake courses allocations
    course_allocations = CourseAllocationFactory.create_batch(num_course_allocations)
    print(f"Created {len(course_allocations)} courses allocations.")
    ...
    # Generate fake courses offers
    course_offers = CourseOfferFactory.create_batch(num_course_offers)
    print(f"Created {len(course_offers)} courses offers.")
