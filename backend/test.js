...
var w = function (t) {
    ...
    for (var s = t.childNodes ? t.childNodes : [], i = e.childNodes ? e.childNodes : [], n = E(s.length, !1), a = E(i.length, !1), o = [], r = function () {
        ...
        var t = function (t, e, s, i) {
            var n = 0, a = [], o = t.length, r = e.length, l = u([], new Array(o + 1), !0).map((function () {
                return []
            })), d = D(t, e), c = o === r;
...
var P = {
    ...
    return t.prototype.init = function () {
        ...
        do {
            ...
            0 === (s = this.findNextDiff(t, e, [])).length && (x(t, e) || (this.foundAll ? console.error("Could not find remaining diffs!") : (this.foundAll = !0, M(t), s = this.findNextDiff(t, e, [])))), s.length > 0 && (this.foundAll = !1, this.tracker.add(s), k(t, s, this.options))
        } while (s.length > 0);
        ...
        var i = t.childNodes ? t.childNodes.slice() : [], n = e.childNodes ? e.childNodes.slice() : [],
            a = Math.max(i.length, n.length), o = Math.abs(i.length - n.length), r = [], l = 0;
        ...
        for (var a, o, r, l, d, c = function (t, e, s) {
            var i = t.childNodes ? E(t.childNodes.length, !0) : [], n = e.childNodes ? E(e.childNodes.length, !0) : [],
                a = 0;
...
const q = (t, e, s, {classes: i, format: n, hiddenHeader: a, sortable: o, scrollY: r, type: l}, {
    noColumnWidths: d,
    unhideHeader: h
}) => ({
                ...
                const s = {
                    ...
                    childNodes: t.cells.map(((t, s) => {
                        ...
                        const r = {
                            ...
                            childNodes: "html" === o.type ? t.data : [{nodeName: "#text", data: n(t)}]
                        };
    ...
    if (M.attributes.class = c(M.attributes.class, r.table), d || h || w) {
        const t = q(e, i, a, {classes: r, hiddenHeader: l, sortable: p, scrollY: f}, {
            noColumnWidths: v,
            unhideHeader: _
        });
        if (d || w) {
...
var z = {exports: {}}, U = B(z.exports = function () {
    var t = 1e3, e = 6e4, s = 36e5, i = "millisecond", n = "second", a = "minute", o = "hour", r = "day", l = "week",
        d = "month", c = "quarter", h = "year", u = "date", p = "Invalid Date",
        ...
        m = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, g = {
            ...
            s: b, z: function (t) {
                ...
                var i = 12 * (s.year() - e.year()) + (s.month() - e.month()), n = e.clone().add(i, d), a = s - n < 0,
    ...
    var O = function () {
        ...
        return b.parse = function (t) {
            ...
            var i = t || "YYYY-MM-DDTHH:mm:ssZ", n = x.z(this), a = this.$H, o = this.$m, r = this.$M, l = s.weekdays,
                d = s.months, c = s.meridiem, h = function (t, s, n, a) {
            ...
            var f, m = this, g = x.p(u), b = N(i), v = (b.utcOffset() - this.utcOffset()) * e, _ = this - b,
                w = function () {
                    return x.m(m, b)
                };
            switch (g) {
...
}()), W = {exports: {}}, J = B(W.exports = function () {
    var t = {
            LTS: "h:mm:ss A",
            LT: "h:mm A",
            L: "MM/DD/YYYY",
        ...
        }, e = /(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, s = /\d\d/,
        i = /\d\d?/, n = /\d*[^-_:/,()\s\d]+/, a = {}, o = function (t) {
            ...
            if ("string" == typeof r) {
                ...
                d && (h = o[2]), a = this.$locale(), !l && h && (a = s.Ls[h]), this.$d = function (t, e, s) {
                    try {
                        ...
                        var i = u(e)(t), n = i.year, a = i.month, o = i.day, r = i.hours, l = i.minutes, d = i.seconds,
                            c = i.milliseconds, h = i.zone, p = new Date, f = o || (n || a ? 1 : p.getDate()),
        ...
        cells: Array.from(t.cells).map(((t, e) => {
            const i = t.dataset.content ? X(t.dataset.content, s[e]) : ((t, e) => {
                ...
                switch (e.type) {
                    ...
                    default:
                        s = {data: S(t, {valueDiffing: !1}).childNodes || [], text: t.innerText, order: t.innerText}
                }
...
class nt {
    ...
    _render() {
        ...
        e && this.options.paging && this.options.perPageSelect ? this.options.perPageSelect.forEach((t => {
            const [s, i] = Array.isArray(t) ? [t[0], t[1]] : [String(t), t], n = i === this.options.perPage,
    ...
    _renderTable(t = {}) {
        ...
        let s = F(this._tableAttributes, this.data.headings, e, this.columns.settings, this.columns._state, this.rows.cursor, this.options, t, this._tableFooters, this._tableCaptions);
    ...
    _renderSeparateHeader() {
        ...
        let e = {
            ...
            childNodes: [{
                nodeName: "THEAD",
                childNodes: [q(this.data.headings, this.columns.settings, this.columns._state, this.options, {unhideHeader: !0})]
            }]
        };
    ...
    _bindEvents() {
        ...
        this.options.searchable && this.wrapperDOM.addEventListener("input", (t => {
            ...
            if (Array.from(this.wrapperDOM.querySelectorAll(e)).filter((t => t.value.length)).forEach((t => {
                ...
                })) : t.dataset.columns ? i.push({terms: s, columns: JSON.parse(t.dataset.columns)}) : i.push({
                    terms: s,
                    columns: void 0
                })
    ...
    multiSearch(t) {
        ...
        if (this.emit("datatable.multisearch:before", e, this._searchData), this._searchQueries = e, !e.length) return this.update(), this.emit("datatable.multisearch", e, this._searchData), this.wrapperDOM.classList.remove("search-results"), !1;
    ...
    print() {
        const t = s("table");
        let e = F(this._tableAttributes, this.data.headings, this.data.data.map(((t, e) => ({
            row: t,
            index: e
    ...
    setMessage(t) {
        ...
        let s = {
            ...
            childNodes: [{
                nodeName: "THEAD",
                childNodes: [q(this.data.headings, this.columns.settings, this.columns._state, this.options, {})]
            }, {
                nodeName: "TBODY",
                childNodes: [{
                    nodeName: "TR",
...
const at = function (e) {
    ...
    if (r.length) {
        ...
        if (i.download) {
            const t = new Blob([e], {type: "data:application/json;charset=utf-8"}), s = URL.createObjectURL(t),
...
class ut {
    ...
    saveCell(t) {
        const e = this.data.content, s = this.dt.columns.settings[this.data.columnIndex].type || this.dt.options.type,
            i = t.trim();
        let n;
        if ("number" === s) n = {data: parseFloat(i)}; else if ("boolean" === s) n = ["", "false", "0"].includes(i) ? {
            ...
            text: "false",
            order: 0
        } : {data: !0, text: "true", order: 1}; else if ("html" === s) n = {
        ...
        if (t) {
            ...
            i.cells = e.map(((e, i) => {
                ...
                if ("number" === n) o = {data: parseFloat(a)}; else if ("boolean" === n) o = ["", "false", "0"].includes(a) ? {
                    ...
                    text: "false",
                    order: 0
                } : {data: !0, text: "true", order: 1}; else if ("html" === n) o = {
                    data: [{
                        nodeName: "#text",
                        data: a
                    }], text: a, order: a
...
class mt {
    ...
    init() {
        ...
        if (!e) {
            e = s("button", {class: this.options.classes.button, html: "в–¦"});
